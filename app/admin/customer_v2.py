...
def handle_export(data):
    ...
    worksheet.write(3, 15, 'Bấm móng tay', header_cell_format)
    worksheet.write(3, 16, 'Ly thuỷ tinh', header_cell_format)
    worksheet.write(3, 17, 'Đồng hồ', header_cell_format)
...
class CustomerV2Admin(nested_admin.NestedModelAdmin,):
    ...
    #     return Customer.objects.filter(created_at__gte='2022-10-25')
    ...
    def get_queryset(self, request):
        qs = super().get_queryset(request)\
            ...
            .prefetch_related('invoices__gifts')\
            .prefetch_related('invoices__gifts__gift')\
            .prefetch_related('market__system__province')\
        ...
        class MyChangeList(ChangeList):
            ...
            def get_queryset(self, request):
                return super().get_queryset(request)\
                    .filter(created_at__gte='2022-10-27 00:00:00')
            ...
            def __init__(self, *args, **kwargs):
                ...
                self.GIFT_BILL_59K = self.HOP_BAM_MONG_TAY

                self.GIFT_BILL_79K = int(self.LY_THUY_TINH) + int(self.DONG_HO_DEO_TAY)
                
                self.GIFT_BILL_129K = int(self.UNICORN_KHONG_LO) + int(self.TUI_TOTE) + int(self.MAY_LA_TOC)

        return MyChangeList

    change_list_template = "HomepageV2.html"